    ...
    <div id="addModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative w-full max-w-lg bg-white dark:bg-gray-800 rounded-2xl shadow-2xl">
                ...
                <form id="addMaterialForm" action="{{ route('dosen.material.store', $course['id']) }}" method="POST" class="p-6" onsubmit="return handleAddMaterialSubmit(event)" x-data="{ isLoading: false }" @submit="isLoading = true">
                    @csrf
