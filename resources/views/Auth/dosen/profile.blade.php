<x-layouts.dosen title="Profil Dosen" active="profile">

{{-- Header --}}
<div class="mb-8 animate-fade-in-up">
    <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Profil Dosen</h1>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="no_hp"
                        value="{{ old('no_hp', $dosen->profile?->no_hp ?? '') }}"
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-y"
                    >{{ old('bio', $dosen->profile?->bio ?? '') }}</textarea>
                </div>
