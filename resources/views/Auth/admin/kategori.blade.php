<x-layouts.admin title="Kelola Kategori" active="kategori">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50 p-4 mb-6">
        <div class="admin-responsive-toolbar flex flex-wrap items-center gap-3">
            ...
            <div class="relative">
                <select class="appearance-none px-4 py-2 pr-10 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-xl text-sm text-gray-700 dark:text-gray-300">
            ...
            <div class="admin-search-group relative w-full sm:flex-1 sm:min-w-[200px] sm:max-w-xs sm:ml-auto">
                <input type="text" placeholder="Cari kode atau nama kategori..." class="w-full px-4 py-2 pl-9 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-xl text-sm text-gray-700 dark:text-gray-300 placeholder-gray-400">
