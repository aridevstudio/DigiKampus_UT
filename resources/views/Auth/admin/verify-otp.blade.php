...
<head>
    ...
    <title>Verifikasi OTP Admin - SALUT</title>
    ...
    <div class="hidden lg:flex min-h-screen" style="background: linear-gradient(to right, #E8F0FE, #FFFFFF);">
        ...
        <div class="flex-1 flex items-center justify-center px-16 py-12">
            <div class="w-full max-w-md">
                ...
                {{-- Form --}}
                <form method="POST" action="{{ route('admin.verify-otp.post') }}" class="space-y-6" x-data="{ isLoading: false }" @submit="isLoading = true">
                    @csrf
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-500">
                        Belum menerima kode? 
                        <a href="{{ route('admin.forgot-password') }}" class="text-blue-500 hover:text-blue-600 hover:underline">
                            Kirim ulang
                        </a>
                    </p>
                </div>
    ...
    <section class="lg:hidden min-h-screen flex flex-col items-center justify-center bg-white px-4 sm:px-6 py-6 sm:py-8">
        <div class="w-full max-w-sm sm:max-w-md flex flex-col items-center">
            ...
            <div class="text-center mb-6">
                ...
                {{-- Form --}}
            <form method="POST" action="{{ route('admin.verify-otp.post') }}" class="w-full space-y-5" x-data="{ isLoading: false }" @submit="isLoading = true">
                @csrf
