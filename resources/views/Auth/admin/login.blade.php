        ...
        <div class="flex-1 flex items-center justify-center px-16 py-12">
            <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('admin.login.post') }}" class="space-y-5" x-data="{ isLoading: false }" @submit="isLoading = true">
                    ...
                    <div class="relative animate-hidden animate-fade-in-up stagger-1">
                        <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25H4.5a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5H4.5a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-.832 1.757l-7.5 6.136a2.25 2.25 0 01-2.836 0l-7.5-6.136A2.25 2.25 0 012.25 6.993V6.75" />
                            </svg>
                        </span>
                        <input 
                            type="email"
                    ...
                    <div class="relative animate-hidden animate-fade-in-up stagger-2">
                        ...
                        <button 
                            ...
                            onclick="const input = this.parentElement.querySelector('input[name=password]'); const willShow = input.type === 'password'; input.type = willShow ? 'text' : 'password'; this.querySelector('[data-password-visible]').style.display = willShow ? 'block' : 'none'; this.querySelector('[data-password-hidden]').style.display = willShow ? 'none' : 'block'; this.setAttribute('aria-label', willShow ? 'Sembunyikan kata sandi' : 'Tampilkan kata sandi');"
                            class="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-400 hover:text-gray-600 password-toggle"
                        >
                            <svg data-password-visible style="display:none;" class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                            <svg data-password-hidden class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                    ...
                    >
                        ...
                        {{-- Fallback text keeps the primary action visible before Alpine initializes. --}}
                        <span x-text="isLoading ? 'Memuat...' : 'Masuk Sekarang'">Masuk Sekarang</span>
                    </button>
                </form>
                ...
                <div class="mt-8 flex items-center justify-between text-xs text-gray-400 footer-animate">
                    ...
                    <span>{{ date('Y') }} &copy; Universitas Terbuka</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="w-full max-w-sm sm:max-w-md flex flex-col items-center">
            ...
            <form method="POST" action="{{ route('admin.login.post') }}" class="w-full space-y-4" x-data="{ isLoading: false }" @submit="isLoading = true">
                ...
                <div class="relative">
                    ...
                    >
                        <svg data-password-visible style="display:none;" class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                        <svg data-password-hidden class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" />
                        </svg>
                    </button>
                </div>
