<x-layouts.admin title="Kelola Mahasiswa" active="mahasiswa">
                    ...
                    <tr class="group hover:bg-blue-50/40 dark:hover:bg-blue-900/10 transition-colors duration-150">
                        ...
                        <td class="px-5 py-4">
                            ...
                            <div class="flex items-center gap-3.5">
                                @if($mhs['foto_url'])
                                    <img src="{{ $mhs['foto_url'] }}" alt="{{ $mhs['nama'] }}" class="admin-profile-avatar w-10 h-10 rounded-full object-cover ring-2 ring-white dark:ring-gray-700 shadow-sm flex-shrink-0" onerror="this.classList.add('hidden'); this.nextElementSibling.classList.remove('hidden'); this.nextElementSibling.classList.add('flex');">
                                    <div class="admin-profile-avatar hidden w-10 h-10 rounded-full {{ $bgColor }} items-center justify-center text-white text-sm font-bold ring-2 ring-white dark:ring-gray-700 shadow-sm flex-shrink-0">
                                        {{ $initials }}
                                    </div>
                                @else
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative w-full max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6">
                ...
                <div id="importStep1">
                    <div class="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                        ...
                        <p class="mt-2 text-xs text-blue-700/90 dark:text-blue-300/90">
                            Gunakan <span class="font-semibold">kode_jurusan</span> sesuai master prodi. Kolom jurusan tidak dipakai. Status kosong akan otomatis menjadi aktif.
                        </p>
                        <p class="mt-1 text-xs text-blue-700/90 dark:text-blue-300/90">
                            Password default hasil import = <span class="font-semibold">Nomor Induk</span>. Mahasiswa harus memakai menu forgot password saat pertama kali login.
                        </p>
                        <div class="mt-2">
                ...
                <div id="importStep2" class="hidden">
                    ...
                    <div class="mb-4">
                        <label class="block text-xs text-gray-600 dark:text-gray-400 mb-1.5">Strategi Duplikat (Email / Nomor Induk sudah ada):</label>
    ...
    <script>
        ...
        function showPreview(preview) {
            ...
            // Preview table: show valid and invalid rows so admins can fix the exact row.
            ...
            if (previewRows.length > 0) {
                ...
                table.innerHTML = '<p class="p-4 text-sm text-gray-400 text-center">Tidak ada data yang bisa dibaca</p>';
            }
