...
<head>
    ...
    <title>Atur Ulang Kata Sandi Admin - SALUT</title>
    ...
    <div class="hidden lg:flex min-h-screen" style="background: linear-gradient(to right, #E8F0FE, #FFFFFF);">
        ...
        <div class="flex-1 flex items-center justify-center px-16 py-12">
            <div class="w-full max-w-md">
                ...
                {{-- Form --}}
                <form id="reset-form-desktop" method="POST" action="{{ route('admin.reset-password.post') }}" onsubmit="return validatePasswordDesktop(event);" class="space-y-4" x-data="{ isLoading: false }" @submit="isLoading = true">
                    @csrf
    ...
    <section class="lg:hidden min-h-screen flex flex-col items-center justify-center bg-white px-4 sm:px-6 py-6 sm:py-8">
        <div class="w-full max-w-sm sm:max-w-md flex flex-col items-center">
            ...
            <div class="text-center mb-6">
                ...
                {{-- Form --}}
            <form id="reset-form-mobile" method="POST" action="{{ route('admin.reset-password.post') }}" onsubmit="return validatePasswordMobile(event);" class="w-full space-y-3" x-data="{ isLoading: false }" @submit="isLoading = true">
                @csrf
