<x-layouts.admin title="Kategori Forum" active="forum-kategori">
    ...
    <form method="GET" action="{{ route('admin.forum-kategori') }}" class="admin-toolbar-responsive bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50 p-4 mb-6">
        <div class="space-y-2 sm:space-y-0 sm:flex sm:flex-wrap sm:items-center sm:gap-3">
            <div class="admin-toolbar-actions flex flex-wrap gap-1.5">
                <button type="button" onclick="openAddKategoriModal()" class="inline-flex items-center gap-1.5 px-3 py-1.5 sm:px-3.5 sm:py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xs sm:text-sm font-medium rounded-xl transition">
