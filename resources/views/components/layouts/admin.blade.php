        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 flex w-[280px] flex-col overflow-hidden bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-40 transform -translate-x-full lg:translate-x-0 transition-transform duration-300">
            ...
            @php
                ...
                $navActive = [
                    ...
                    'system-logs'       => request()->routeIs('admin.system-logs*'),
                ];
            ...
            <nav class="min-h-0 flex-1 overflow-y-auto overscroll-contain p-4 space-y-2">
                ...
                <a href="{{ route('admin.system-logs') }}" title="System Log Viewer" @if($navActive['system-logs']) aria-current="page" @endif class="{{ $navItemBase }} {{ $navActive['system-logs'] ? $navItemActive : $navItemIdle }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                    </svg>
                    <span class="sidebar-text font-medium text-sm">System Logs</span>
                    <span class="sidebar-tooltip">System Logs</span>
                </a>
            </nav>
        </aside>
