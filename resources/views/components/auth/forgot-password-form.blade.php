    ...
    <div class="w-full max-w-6xl flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-16 mx-auto">
        ...
        <div class="flex-1 w-full max-w-sm sm:max-w-md px-2 sm:px-0">
            <div class="flex flex-col items-center">
                ...
                {{-- Form --}}
                <form method="POST" action="{{ route('mahasiswa.forgot-password.post') }}" class="w-full space-y-4 sm:space-y-6" x-data="{ isLoading: false }" @submit="isLoading = true">
                    @csrf
                    ...
                    >
                        ...
                        <span x-text="isLoading ? 'Memuat...' : 'Kirim OTP'"></span>
                    </button>
                </form>
