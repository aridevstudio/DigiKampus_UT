            ...
            <div class="flex flex-col items-center">
                ...
                <form method="POST" action="{{ route('mahasiswa.post') }}" class="w-full space-y-4 sm:space-y-5" x-data="{ isLoading: false }" @submit="isLoading = true">
                    ...
                    <div class="relative animate-hidden animate-fade-in-up stagger-2" x-data="{ show: false }">
                        ...
                        >
                            <svg x-show="show" style="display:none;" class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                            <svg x-show="!show" class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
