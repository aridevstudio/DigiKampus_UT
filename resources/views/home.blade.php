...
<body>
    ...
    <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 px-3 sm:px-6 pt-3 sm:pt-4">
        <div class="nav-glass max-w-6xl mx-auto px-3.5 sm:px-6 h-14 flex items-center justify-between gap-3">
            <a href="/" class="flex min-w-0 flex-1 items-center gap-2.5 overflow-hidden" style="text-decoration:none">
                ...
                <div class="brand-responsive-text min-w-0 flex-col leading-none sm:flex-row sm:items-baseline sm:gap-1">
                    <span class="truncate" style="font-family:var(--font-display);font-weight:700;font-size:15px;color:var(--c-text)">DigiKampus</span>
                    <span class="shrink-0 text-[11px] font-semibold leading-none" style="color:var(--c-text-light)">UT</span>
                </div>
            </a>
